...
public class DecodeTheMorseCodeAdvancedKataTests
{
    ...
    [Fact]
    public void On_Success_Should_Validate_DecodeTheMorseCodeAdvancedKata_DecodeMorse_Zeros_Handling()
    {
        DecodeTheMorseCodeAdvancedKata.DecodeMorse(DecodeTheMorseCodeAdvancedKata.DecodeBits("01110"))
            .Should().Be("E");
    }
}
